...
class game_ball():
    ...
    def draw(self):
        ...
        pygame.draw.circle(screen, board_outline, (self.rect.x + self.ball_rad, self.rect.y + self.ball_rad),
                           self.ball_rad, 3)
...
while run:
    ...
    if not live_ball:
        if game_over == 0:
            draw_text('CLICK ANYWHERE TO START', font, text, 100, screen_height // 2 + 100)
        elif game_over == 1:
            draw_text('YOU WON!', font, text, 240, screen_height // 2 + 50)
            draw_text('CLICK ANYWHERE TO START', font, text, 100, screen_height // 2 + 100)
        elif game_over == -1:
            draw_text('YOU LOST!', font, text, 240, screen_height // 2 + 50)
            draw_text('CLICK ANYWHERE TO START', font, text, 100, screen_height // 2 + 100)
